    ...
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={`${layout.sectionInfo}`}>
        ...
        <p className={`${style.paragraph} max-w-[470px] mt-5`}>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate repellat architecto, laudantium debitis officiis maiores accusantium non! Iure itaque, possimus magni sequi animi illum sunt similique!
        </p>
