...
const HeroSection = () => {
  return (
    ...
    >
      ...
      >
        <div className="dicount-title flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
        ...
        <p className={`${style.paragraph} max-w-[470px] mt-5`}>
          ...
          most likely to fit your needs. We examine annual percentage rated,
          annual fees.
        </p>
      </div>
      <div
